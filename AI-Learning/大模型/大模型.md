...
#### 简介
Latent.Space总结了选择了 50 篇/模型/博客，涵盖 AI 领域的 10 个方向：LLMs、基准、提示、RAG、代理、CodeGen、视觉、语音、扩散、微调。  
每篇文章的选择都是基于其对人工智能工程师职业发展的重要性和对未来技术趋势的预测。  
（作者：蚁工厂 原文：https://weibo.com/2194035935/P7FQEv3w9）

## 2024 年大型语言模型领域回顾
#### 地址
https://simonwillison.net/2024/Dec/31/llms-in-2024/?continueFlag=4eb33b14b5288121f74719c13c0c4a02
...
#### 简介
这个Github项目为大型语言模型的工程师提供全面的指导和支持。它包括了模型训练的最佳实践、部署方法、微调技巧以及构建基于 LLM 的应用程序的策略。  
这份手册不仅汇集了各种实用的资源，如文档、教程和工具，而且还提供了关于如何有效利用这些资源来提升 LLM 项目的成功率的见解。  
...
## Anthropic：构建有效代理（agents）的实践经验和建议
#### 地址
https://www.anthropic.com/research/building-effective-agents?continueFlag=4eb33b14b5288121f74719c13c0c4a02
#### 简介
文章指出，成功的大型语言模型（LLM）代理实现并不依赖复杂框架或专用库，而是简单的、可组合的模式。  
文章区分了工作流（workflows）和代理（agents），前者通过预定义的代码路径协调LLM和工具，后者则由LLM动态指导自己的流程和工具使用。  
文章提供了关于何时使用代理、如何使用框架、构建块、工作流和代理的实用建议，并强调了在构建代理时应保持简单性、透明度，并精心设计代理与计算机界面（ACI）。
...
#### 简介
清华大学五道口金融学院财富管理研究中心的研究报告  
（作者：蚁工厂 原文：https://weibo.com/2194035935/P7KylCJXm）
#### 目录
![输入图片说明](../../images/LLM%E6%97%B6%E4%BB%A3%E5%B0%8F%E6%A8%A1%E5%9E%8B%E7%9A%84%E5%BA%94%E7%94%A8%E6%BD%9C%E5%8A%9B%E4%B8%8E%E6%8C%91%E6%88%98_List.png)
![输入图片说明](../../images/LLM%E6%97%B6%E4%BB%A3%E5%B0%8F%E6%A8%A1%E5%9E%8B%E7%9A%84%E5%BA%94%E7%94%A8%E6%BD%9C%E5%8A%9B%E4%B8%8E%E6%8C%91%E6%88%98_List2.png)
